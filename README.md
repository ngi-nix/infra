...
To get access to `makemake`, open a pull request where you add your public SSH key to the [`keys`](./makemake/keys) directory and the list of authorized keys for the `remotebuild` user in [`users.nix`](./makemake/users.nix).
